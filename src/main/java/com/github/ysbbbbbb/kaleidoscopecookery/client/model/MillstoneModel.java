...
public class MillstoneModel extends Model {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r1 = stick.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(83, 31).addBox(-8.0F, -2.0F, -2.0F, 16.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 1.0F, -1.5708F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r3 = stick.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(112, 70).addBox(-2.0F, -22.0F, -3.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.9F, -37.0F, -1.5708F, 0.0F, 0.0F));

        PartDefinition cube_r4 = stick.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(111, 84).addBox(-2.0F, -22.0F, -3.0F, 4.0F, 28.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.0F, -37.0F, -1.5708F, 0.0F, 0.0F));

        PartDefinition cube_r5 = stick.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(83, 31).addBox(-8.0F, -2.0F, -2.0F, 16.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, -17.0F, -1.5708F, 0.0F, 0.0F));
